...
const DonateButton = ({ onPress, title, isDarkMode }) => (
  ...
  >
    <Text style={[styles.donateButtonText, isDarkMode && styles.donateButtonTextDark]}>
      {title}
    </Text>
  </TouchableOpacity>
);
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              <View style={styles.cardContent}>
                <Text
                  style={[styles.cardTitle, isDarkMode && styles.darkText]}
                >
                  {item.title}
                </Text>
                <Text
                ...
                <View style={styles.cardInfoRow}>
                  <View style={styles.cardInfoBox}>
                    ...
                    <Text
                      style={[styles.cardInfoValue, isDarkMode && styles.darkText]}
                    >
                      {item.raised}
                    </Text>
                  </View>
                ...
                <DonateButton title="Donate" onPress={() => {}} isDarkMode={isDarkMode} />
              </View>
            </View>
          )}
        />
