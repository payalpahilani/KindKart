...
const otherAds = [
  ...
  { id: '4', image: require('../../assets/Images/bag.jpg'),  title: 'Product title....', price: '00.000 CAD' },
  { id: '5', image: require('../../assets/Images/tv.jpg'),   title: 'Product title....', price: '00.000 CAD' },
  { id: '6', image: require('../../assets/Images/shoes.jpg'),title: 'Product title....', price: '00.000 CAD' },
];
      ...
      >
        ...
        <View style={st.searchRow}>
          <View style={[st.searchInputWrap]}>
            <Icon name="magnify" size={20} color={isDarkMode ? '#bbb' : '#A0A0A0'} />
            <TextInput
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={st.categoriesRow}>
          ...
          renderItem={({ item }) => (
            <View style={st.adCard}>
              ...
              <View style={st.adActionsRow}>
                <Icon name="share-variant" size={20} color={isDarkMode ? '#bbb' : '#A0A0A0'} />
                <Icon name="bookmark-outline" size={20} color={isDarkMode ? '#bbb' : '#A0A0A0'} style={{ marginLeft: 16 }} />
              </View>
            </View>
          )}
        />
...
const common = StyleSheet.create({
  ...
  filterButton: {
    marginLeft: 12, borderRadius: 10, padding: 10,
  ...
  adCard: {
    width: width * 0.5, borderRadius: 12, marginRight: 18, padding: 10,
    shadowOffset: { width: 0, height: 2 }, elevation: 2,
  },
  adImage: { width: '100%', height: 90, borderRadius: 10, marginBottom: 8 },
  adInfoRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 2 },
  ...
  gridWrap: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', marginTop: 4 },
  gridCard: {
    width: (width - 48) / 2, borderRadius: 12, marginBottom: 18, padding: 8,
    shadowOffset: { width: 0, height: 2 }, elevation: 2,
  },
...
const light = StyleSheet.create({
  ...
  headerTitle: { fontSize: 26, fontWeight: 'bold', color: '#23253A', marginBottom: 16, marginTop: 8, lineHeight: 30 },
  ...
  adCard: { ...common.adCard, backgroundColor: '#fff', shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 4 },
  ...
  gridCard: { ...common.gridCard, backgroundColor: '#fff', shadowColor: '#000', shadowOpacity: 0.06, shadowRadius: 4 },
  gridTitle: { fontSize: 14, color: '#23253A', fontWeight: '600', marginBottom: 2 },
...
const dark = StyleSheet.create({
  ...
  headerTitle: { fontSize: 26, fontWeight: 'bold', color: '#eee', marginBottom: 16, marginTop: 8, lineHeight: 30 },
  ...
  adCard: { ...common.adCard, backgroundColor: '#1E1E1E', shadowColor: '#000', shadowOpacity: 0.8, shadowRadius: 4 },
  adCategory: { ...common.adCategory, color: '#FF7A7A' },
  adLocation: { ...common.adLocation, color: '#2CB67D' },
  adTitle: { ...common.adTitle, color: '#eee' },
  adPrice: { ...common.adPrice, color: '#eee' },
  gridCard: { ...common.gridCard, backgroundColor: '#1E1E1E', shadowColor: '#000', shadowOpacity: 0.8, shadowRadius: 4 },
  gridTitle: { fontSize: 14, color: '#eee', fontWeight: '600', marginBottom: 2 },
