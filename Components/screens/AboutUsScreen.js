    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.bodyText}>
          KindKart is more than just a platform. It’s a movement—a bridge
          between generous hearts and genuine needs. Whether it's helping a
          family in need, supporting a local charity, or backing grassroots
          causes, we aim to make generosity easy and meaningful.
        </Text>

        <Text style={styles.subheading}>🎯 Our Mission</Text>
        <Text style={styles.bodyText}>
          To build a transparent and accessible platform where people can donate
          with confidence and see the real impact of their kindness.
        </Text>

        <Text style={styles.subheading}>🚀 How We Achieve It</Text>
        <Text style={styles.bodyText}>
          - Verified campaigns with full transparency{"\n"}- User-friendly
          donation process{"\n"}- Real-time updates and stories from
          beneficiaries{"\n"}- Data security and privacy-first design
        </Text>

        <Text style={styles.subheading}>🤝 Join Us</Text>
        <Text style={styles.bodyText}>
          By using KindKart, you're not just giving—you’re becoming part of a
          compassionate community. Thank you for being here.
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
